...
{
    public abstract class DistantPointExeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static DistantPointExeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(DistantPointExeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<DistantPointExeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<DistantPointExeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<DistantPointExeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<DistantPointExeDbContext, Task<T>> func)
        {
            T result;
